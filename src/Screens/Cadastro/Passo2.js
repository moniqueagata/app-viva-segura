...
import { Pressable, Text, View, Animated, Image, Platform, KeyboardAvoidingView, ScrollView, SafeAreaView } from 'react-native';
            ...
            <View style={styles.content}>
              <View style={styles.logo}>
                ...
                <View style={styles.inputsContainer}>
                  ...
                  <PaperInput
                    label={<Text style={{ fontSize: 15, letterSpacing: 0.4 }}>Data de nascimento</Text>}
                    mode='outlined'
                    style={{ backgroundColor: '#fff', height: 50, width: '95%' }}
                    outlineColor='#ddd'        
                    activeOutlineColor='#6925b8' 
